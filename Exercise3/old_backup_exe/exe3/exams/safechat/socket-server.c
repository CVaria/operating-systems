	...
	for (;;) {
		...
		for(;;){
			...
			if(server_writes){
				...
				for(i=0;i<DATA_SIZE;i++)	data.in[i] = buf[i];
				...
				*/
				...
				for(i=0;i<DATA_SIZE;i++)	buf[i]=data.encrypted[i];						
			...
			if(server_reads){
				...
				for(i=0;i<DATA_SIZE;i++)  data.encrypted[i]=buf[i];
				printf("Encrypted data:\n");
				for(i=0;i<DATA_SIZE;i++)  printf("%x",data.encrypted[i]);
				printf("\n");				
				...
				*/
				...
				for(i=0;i<DATA_SIZE;i++)	buf[i]=data.decrypted[i];			
